...
export const WAVES = [
  // ---------------- Round 1: FIGHT! -----------------
    [
      ...
      { at: 170, type:'moth', x: 120, sy: -15, pat: 'straight', vy:1.2 },

      { at: 290, type:'jet', x: 95,  sy: -15, pat:'drift_r', vy:2 },
      { at: 320, type:'jet', x: 45,  sy: -15, pat:'drift_r', vy:2 },
      { at: 330, type:'jet', x: -5,  sy: -15, pat:'drift_r', vy:2 },
      ...
      { at: 470, type:'jet', x: 395,  sy: -15, pat:'drift_l', vy:2 },
      { at: 500, type:'jet', x: 445,  sy: -15, pat:'drift_l', vy:2 },
      { at: 530, type:'jet', x: 495,  sy: -15, pat:'drift_l', vy:2 },

      { at: 550, type:'beetle', x: 240, sy: -15, pat:'straight', vy:0.75 },
    ],
